...
import { AddDoctor, CheckIfDoctorAccountIsApplied, UpdateDoctor, } from '../../apicalls/doctor';
            ...
            {(!alreadyApplied || alreadyApproved) && (<><h3
                ...
                >
                    ...
                    <div className='flex justify-end gap-2'>
                        <button className='outlinedbtn' type='button'>
                            CANCEL
                        </button>
                        <button className='containedbtn' type='submit'>
                            SUBMIT
                        </button>
                    </div>
                </Form></>)}
            {alreadyApplied && !alreadyApproved && (
                <div className='flex flex-col items-center gap-2'>
                    <h3 className='text-secondary'>You have already applied for this doctor account,
                        please wait for the admin to approve your request</h3>
